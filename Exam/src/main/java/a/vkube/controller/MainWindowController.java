...
public class MainWindowController {
    ...
    @FXML
    private TableColumn<Driver, LocalDate> columnBirthday;

    @FXML
    private TableColumn<Driver, String> columnAdress;
    ...
    void initialize(){
        ...
        columnBirthday.setCellValueFactory(o -> new SimpleObjectProperty<>(o.getValue().getBirthday()));
        columnAdress.setCellValueFactory(o -> new SimpleObjectProperty<>(o.getValue().getAdress()));
